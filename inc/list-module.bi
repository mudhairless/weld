#ifndef __inc__list_module__bi__
#define __inc__list_module__bi__ 1

#include once "module.bi"
#include once "list.bi"

type fbe_ListNode__module
        rep as ListNode__
        obj as module

        declare constructor ( byref as const fbe_ListNode__module )
        declare destructor ( )
end type

type fbe_ListIterator__module
public:
    ...
    declare function Get ( ) as module ptr
    ...
    declare function PostIncrement ( ) as fbe_ListIterator__module
    ...
    declare function PostDecrement ( ) as fbe_ListIterator__module
...
type fbe_ListIteratorToConst__module
public:
    '' Sub: conversion from ListIterator__ constructor
    '' Constructs an iterator.
    declare constructor ( byref x as const fbe_ListIterator__module )
    ...
    declare function Get ( ) as const module ptr
    ...
    '' Returns:
    '' Returns the value of the iterator before being incremented.
    declare function PostIncrement ( ) as fbe_ListIteratorToConst__module
    ...
    '' Returns:
    '' Returns the value of the iterator before being decremented.
    declare function PostDecrement ( ) as fbe_ListIteratorToConst__module
...
'' Equivalent to `fbe_ListIterator__module.Get()`.
declare operator * ( byref self as const fbe_ListIterator__module ) as module ptr
'' Operator: dereference
'' Equivalent to `fbe_ListIteratorToConst__module.Get()`.
declare operator * ( byref self as const fbe_ListIteratorToConst__module ) as const module ptr
...
'' otherwise.
declare operator = ( byref x as fbe_ListIterator__module, byref y as fbe_ListIterator__module ) as boolean
declare operator = ( byref x as fbe_ListIteratorToConst__module, byref y as fbe_ListIteratorToConst__module ) as boolean
...
type fbe_Allocator_module
    public:
        ...
        declare constructor ( byref x as const fbe_Allocator_module )
        ...
        declare function Allocate ( byval n as uinteger, byval hint as module ptr = 0 ) as module ptr
        ...
        declare sub DeAllocate ( byval p as module ptr, byval n as uinteger )
        ...
        declare sub Construct ( byval p as module ptr, byref value as const module )
        ...
        declare sub Destroy ( byval p as module ptr )
...
type fbe_Allocator_fbe_ListNode__module
public:
    '' Sub: constructor
    ''  Constructs an allocator object.
    declare constructor ( )
    ...
    ''  object can deallocate memory allocated by the other allocator
    ''  object, and vice-versa.
    declare constructor ( byref x as const fbe_Allocator_fbe_ListNode__module )
    ...
    '' Returns:
    ''  Returns the address of the first object in the array.
    declare function Allocate ( byval n as uinteger, byval hint as fbe_ListNode__module ptr = 0 ) as fbe_ListNode__module ptr
    ...
    ''  p - the address of the first object.
    ''  n - the number of objects contained within the memory.
    declare sub DeAllocate ( byval p as fbe_ListNode__module ptr, byval n as uinteger )
    ...
    ''  p - the address of the object to construct.
    ''  value - the value to construct the object with.
    declare sub Construct ( byval p as fbe_ListNode__module ptr, byref value as const fbe_ListNode__module )
    ...
    '' Parameters:
    ''  p - the address of the object to destroy.
    declare sub Destroy ( byval p as fbe_ListNode__module ptr )
...
type fbe_List_module
public:
    declare static function Iterator as fbe_ListIterator__module
    declare static function IteratorToConst as fbe_ListIteratorToConst__module
    ...
    '' Constructs an empty list.
    declare constructor ( byref x as const fbe_List_module )
    ...
    declare constructor ( byval n as uinteger, byref valu as const module)
    ...
    declare operator let ( byref x as const fbe_List_module )
    ...
    declare sub Assign ( byval n as uinteger, byref x as const module )
    ...
    declare sub Resize ( byval x as uinteger, byref v as const module )
    ...
    declare function Front ( ) as module ptr
    '' Function: cFront
    '' Gets a reference to the first element in the list.
    declare const function cFront ( ) as const module ptr

    '' Function: Back
    '' Gets a reference to the last element in the list.
    declare function Back ( ) as module ptr
    '' Function: cBack
    '' Gets a reference to the last element in the list.
    declare const function cBack ( ) as const module ptr
    ...
    declare sub PushFront ( byref x as const module )
    ...
    '' Parameters:
    '' x - the element value to insert
    declare sub PushBack ( byref x as const module )
    ...
    declare function Insert ( byval position as typeof(Iterator), byref x as const module ) as typeof(Iterator)
    ...
    '' x - the element value to insert
    declare sub Insert ( byval position as typeof(Iterator), byval n as uinteger, byref x as const module )
    ...
    ''
    declare sub Splice ( byval position as typeof(Iterator), byref lst as fbe_List_module )
    ...
    ''
    declare sub Splice ( byval position as typeof(Iterator), byref lst as fbe_List_module, byval frst as typeof(Iterator) )
    ...
    ''
    declare sub Splice ( byval position as typeof(Iterator), byref lst as fbe_List_module, byval frst as typeof(Iterator), byval lastp as typeof(Iterator) )
    ...
    declare sub RemoveIf ( byval pred as function ( byref as const module ) as boolean )

private:
    declare static function T_Allocator as fbe_Allocator_module
    declare function m_CreateNode ( ) as ListNode__ ptr
    declare function m_CreateNode ( byref x as const module ) as ListNode__ ptr

    m_alloc as fbe_Allocator_fbe_ListNode__module
